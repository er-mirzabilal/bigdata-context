...
import rawHtml from "../legacy/product.html?raw";

export const Route = createFileRoute("/product")({
  head: () => ({
    meta: [
      { title: "BCOS Platform — Big Context & Company" },
      { name: "description", content: "The Pragmatic Context Layer that makes your enterprise data legible to AI — without rebuilding your stack." },
      { property: "og:title", content: "BCOS Platform — Big Context & Company" },
      { property: "og:description", content: "The Pragmatic Context Layer that makes your enterprise data legible to AI — without rebuilding your stack." },
    ],
    links: [
